...
class ServicesInfoScreen extends PureComponent {
  ...
  render() {
    return (
      <View style={[styleServicesInfoScreen.container]}>
        <ScrollView>
          <View style={styleServicesInfoScreen.innerContainer}>
            <View>
              <Text style={styleServicesInfoScreen.shopAddress}>
                {this.state.serviceShopAddress}
              </Text>
          ...
          <SplitHeading
            text={__('Services provided' , this.props.language)}
          ...
          <TouchableOpacity style={styles.center} onPress={this.showContact}>
            <View style={styleServicesInfoScreen.contactBtnStyle}>
              <Text style={styleServicesInfoScreen.btnText}>{__('Contact now' , this.props.language)}</Text>
            </View>
          </TouchableOpacity>
        </ScrollView>
        <Modal
				...
				>
					...
					<View style={styleServicesInfoScreen.modelStyle}>
						<View style={styleServicesInfoScreen.modalInnerView}>
                  ...
                  renderItem={({ item, index }) => <TouchableOpacity style={styles.center}  onPress={() => RNImmediatePhoneCall.immediatePhoneCall(item)}>
                ...
                />
                	<TouchableOpacity style={styles.center} onPress={this.showContact}>
								<View style={styleServicesInfoScreen.btnStyle}>
									<Text style={styleServicesInfoScreen.btnText}>Cancel</Text>
								</View>
							</TouchableOpacity>
						</View>
					</View>
        ...
        <View style={{flex:1,backgroundColor:'#08080847'}} >
          ...
          <TouchableOpacity style={styles.center} onPress={this.showContact}>
								  <View style={[styleServicesInfoScreen.cancelBtnStyle, {backgroundColor: '#E6EFF9'}]}>
								  	<Text style={styleServicesInfoScreen.cancelBtnText}>{__('Cancel' , this.props.language)}</Text>
								  </View>
							  </TouchableOpacity>
          </View>
          </View>
...
export default connect(mapStateToProps, null)(ServicesInfoScreen)
