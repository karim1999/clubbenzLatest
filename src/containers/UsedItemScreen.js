...
class UsedItemScreen extends PureComponent {
	ListEmptyView = () => {
	...
	render() {
		return (
			<View style={styleUsedItemScreen.container}>
				<View style={{ flex: 6 }}>
					<FlatList
...
export default UsedItemScreen;
const styleUsedItemScreen = StyleSheet.create({
	container: {
		flex: 1,
		marginTop: -10,
	},
