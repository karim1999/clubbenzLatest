...
class ServicesOffersScreen extends PureComponent {
  ...
  static navigationOptions = ({ navigation }) => ({
    ...
    render() {
        return (
            <View style={[styleServicesOffersScreen.container, {
                alignItems: "center",
                paddingTop: 8
            }]}>
            {
                ...
                >
                    ...
                    <View style={{ flex: 1, backgroundColor: '#08080847' }} >
                        ...
                        <View style={styleServicesOffersScreen.modelStyle}>
                            <View style={styleServicesOffersScreen.modalInnerView}>
                                <View style={[styles.center, { backgroundColor: '#FFFFFF', borderRadius: metrics.radius15, }]}>
                                    ...
                                    <TouchableOpacity style={styles.center} onPress={this.shareFACEBOOK}>
                                        <View style={styleServicesOffersScreen.btnStyle}>
                                            <Text style={styleServicesOffersScreen.btnText} >{__('Facebook', this.props.language)}</Text>
                                        </View>
                                    </TouchableOpacity>

                                    <TouchableOpacity style={styles.center} onPress={this.shareWHATSAPP}>
                                        <View style={styleServicesOffersScreen.btnStyle}>
                                            <Text style={styleServicesOffersScreen.btnText} >{__('WhatsApp', this.props.language)}</Text>
                                        </View>
                                    </TouchableOpacity>

                                    <TouchableOpacity style={styles.center} onPress={() => this.sendSMS()}>
                                        <View style={styleServicesOffersScreen.btnStyle}>
                                            <Text style={styleServicesOffersScreen.btnText} >{__('SMS', this.props.language)}</Text>
                                        </View>
                                    </TouchableOpacity>

                                    <TouchableOpacity style={styles.center} onPress={this.copyLink}>
                                        <View style={styleServicesOffersScreen.btnStyle}>
                                            <Text style={styleServicesOffersScreen.btnText} >{__('Copy Link', this.props.language)}</Text>
                                        </View>
                                    </TouchableOpacity>
                    ...
                    <TouchableOpacity style={styles.center} onPress={() => this.setState({shareModalVisible: !this.state.shareModalVisible})}>
                        <View style={[styleServicesOffersScreen.cancelBtnStyle, { backgroundColor: '#E6EFF9' }]}>
                            <Text style={styleServicesOffersScreen.cancelBtnText}>{__('Cancel', this.props.language)}</Text>
                        </View>
                    </TouchableOpacity>
...
export default connect(mapStateToProps, null)(ServicesOffersScreen);

const styleServicesOffersScreen = StyleSheet.create({
    container: {
        flex: 1,
