...
class WorkshopInfoScreen extends PureComponent {
  ...
  render() {
    ...
    return (
      <View style={[styleWorkshopInfoScreen.container]}>
        <ScrollView>
          <View style={styleWorkshopInfoScreen.innerContainer}>
            <View>
              <Text style={styleWorkshopInfoScreen.shopAddress}>
          ...
          <TouchableOpacity style={styles.center} onPress={this.showContact}>
            <View style={styleWorkshopInfoScreen.contactBtnStyle}>
              <Text style={styleWorkshopInfoScreen.btnText}>{__('Contact now' , this.props.language)}</Text>
            </View>
          </TouchableOpacity>
        </ScrollView>
        <Modal
          ...
          <TouchableOpacity style={styles.center} onPress={this.showContact}>
								  <View style={[styleWorkshopInfoScreen.cancelBtnStyle, {backgroundColor: '#E6EFF9'}]}>
								  	<Text style={styleWorkshopInfoScreen.cancelBtnText}>{__('Cancel' , this.props.language)}</Text>
								  </View>
							  </TouchableOpacity>
          </View>
          </View>
...
export default connect(mapStateToProps, null)(WorkshopInfoScreen)
