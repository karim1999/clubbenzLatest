...
class MyCardScreen extends PureComponent {
    constructor(props) {
        super(props);
        this.state= {
            memberships: [],
    ...
    updateList(){
        let memberships= getMemberships(this.props.user.id).then(res => {
            ...
            if(res.current)
                ...
                this.props.navigation.replace("MembershipsScreen")
            }
        })
    ...
    render() {
        return (
            <View style={Styles.container}>
                ...
                <Header noSearch title={__('My Card')} navigation={this.props.navigation} goBack={true}/>
...
export default connect(mapStateToProps, null)(MyCardScreen)
