...
const es = {
  ...
  'Parts Catalog': 'كتالوج قطع الغيار',
  'Parts Catalogue': 'كتالوج قطع الغيار',
  'Search Parts Catalogue': 'ابحث باسم قطع الغيار او رقمها',
  ...
  'Sign in with Apple': "الدخول عن طريق أبل",
  'Fill your info Apple': 'بياناتك بواسطة أبل',
};
