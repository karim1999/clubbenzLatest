...
const es = {
  ...
  'Get access to the largest spare parts store with simple clicks': 'تمتع بالراحة ووفر وقتك عند البحث عن أي قطعه غيار فلديك الآن أكبر متجر لقطع الغيار بين يديك و بخطوات بسيطة سيمكنك بسهولة الوصول إلى ما تريد وشرائه و يمككنك قراءة تجارب الاخرين مع التجارالعارضة لقطع الغيار',
  'Get Started': ' إبدأالآن',
  'Continue with Facebook': 'استمر من خلال فيسبوك',
  'Or': 'أو',
  'Email Address or Mobile number': 'رقم الموبايل او البريد الالكترون',
  ...
  'Scan your Vin Number': 'ادخل رقم تعرييف سيارتك',
  'Continue': 'استمرار',
  ...
  'My Profile': 'حسابي',
  'Choose another model': 'اختار موديل أخر',
  'Update Changes': 'حفظ التغييرات',
  'Change Language': 'تغيير اللغة',
  'Link to Facebook': 'الربط بفيسبوك',
  'Common requested parts for this model': 'قطع غيار تطلب عادة لهذا الموديل',
  'Explore all listed parts': 'تصفح قطع الغيار المعروضة',
  'All': 'كل القطع',
  'Used': 'قطعة مستعمله',
  'New': 'قطعة جديدة',
  ...
  'Or select your Model': 'أو حدد موديلك',
  'Engine Type': 'نوع المحرك',
  'Model Year': 'اخترسنة الصنع',
